...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleAthleteException(AthleteNotFoundException e, WebRequest request) {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		ApiError error = ApiError.builder().timeStamp(new Date()).errorType(status.getReasonPhrase())
				.message(body != null ? body.toString() : ex.getMessage()).path(requestURI).build();
